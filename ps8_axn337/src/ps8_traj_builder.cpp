#include<ps8_traj_builder/ps8_traj_builder.h>
...
double PS8TrajBuilder::min_dang(double dang) {
...
double PS8TrajBuilder::sat(double x) {
    if (x > 1.0) {
        return 1.0;
    }
    if (x< -1.0) {
...
double PS8TrajBuilder::sgn(double x) {
    if (x > 0.0) {
        return 1.0;
    }
    if (x< 0.0) {
...
double PS8TrajBuilder::convertPlanarQuat2Psi(geometry_msgs::Quaternion quaternion) {
...
geometry_msgs::Quaternion PS8TrajBuilder::convertPlanarPsi2Quaternion(double psi) {
...
geometry_msgs::PoseStamped PS8TrajBuilder::xyPsi2PoseStamped(double x, double y, double psi) {
...
void PS8TrajBuilder::build_trapezoidal_spin_traj(geometry_msgs::PoseStamped start_pose,
...
// profile is needed
void PS8TrajBuilder::build_spin_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
...
void PS8TrajBuilder::build_travel_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    //decide if triangular or trapezoidal profile:
    double x_start = start_pose.pose.position.x;
...
void PS8TrajBuilder::build_trapezoidal_travel_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    double x_start = start_pose.pose.position.x;
    double y_start = start_pose.pose.position.y;
...
void PS8TrajBuilder::build_triangular_travel_traj(geometry_msgs::PoseStamped start_pose, geometry_msgs::PoseStamped end_pose,std::vector<nav_msgs::Odometry> &vec_of_states) {
    double x_start = start_pose.pose.position.x;
    double y_start = start_pose.pose.position.y;
    double x_end = end_pose.pose.position.x;
    double y_end = end_pose.pose.position.y;
...
void PS8TrajBuilder::build_triangular_spin_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    nav_msgs::Odometry des_state;
    des_state.header = start_pose.header; //really, want to copy the frame_id
...
void PS8TrajBuilder::build_braking_traj(geometry_msgs::PoseStamped start_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    //FINISH ME!
	double x_start = start_pose.pose.position.x;
	double y_start = start_pose.pose.position.y;

	double dx = 0.5; //stop in .5 meters
...
void PS8TrajBuilder::build_point_and_go_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
