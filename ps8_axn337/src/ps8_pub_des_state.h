...
#include <queue>
#include <ps8_traj_builder/ps8_traj_builder.h> //has almost all the headers we need

#include <std_msgs/Float64.h>
#include <std_msgs/Bool.h>
#include <std_srvs/Trigger.h>
#include <ps8_axn337/path.h>
#include <std_msgs/Float64.h>
...
private:
    ...
    bool e_stop_alarm; // Modified for lab 8
    bool on_alarm; // Modified by Jonathan
    bool e_stop_on; // Modified for lab 8
    int traj_pt_i_;
    int npts_traj_;
    double dt_;
    //dynamic parameters: should be tuned for target system
    ...
    ros::Subscriber ESTOP_; // Modified for lab 8
...
//    ros::Publisher lidar_dist_publisher_;
    ...
    void estopCB(const std_msgs::Bool& estop_msg); // Modified for lab 8
    ...
    bool appendPathQueueCB(ps8_axn337::pathRequest& request,ps8_axn337::pathResponse& response);

public:
    PS8DesStatePublisher(ros::NodeHandle& nh);//constructor
